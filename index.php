    ...
    <style>
      ...
      * {
      ...
      .menu-card:hover {
        ...
        box-shadow: 0 15px 30px rgba(245, 130, 32, 0.15);
      ...
      /* THE FIX: Targets SVG paths/circles to turn white on hover */
      .menu-card:hover .icon-box svg path {
        stroke: white !important;
      }
      .menu-card:hover .icon-box svg circle {
  ...
  <body>
    ...
    <footer class="social-footer">
      <div class="social-container">
        <button class="social-btn share-btn" title="Share App">
          <i class="fa-solid fa-share-nodes"></i>
        </button>
        <div class="divider-vertical"></div>
        <a
          href="https://m.facebook.com/brainiacgym/"
          target="_blank"
          class="social-btn fb"
          ><i class="fa-brands fa-facebook-f"></i
        ></a>
        <a
          href="https://twitter.com/brainiacgym"
          target="_blank"
          class="social-btn x"
        >
          <svg
        ...
        ></a>
        <a
          href="https://www.linkedin.com/in/brainiacgym"
          target="_blank"
          class="social-btn linkedin"
          ><i class="fa-brands fa-linkedin-in"></i
        ></a>
        <a
          href="https://youtube.com/@abacusclassesbrainiacgym"
          target="_blank"
          class="social-btn yt"
